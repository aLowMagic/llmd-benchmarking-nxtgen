#!/usr/bin/env python3
"""Plot TTFT and output tok/s for llm-d vs plain k8s, sarvam-30b, rates 3-50.

Same plot style as 2.1/precise-prefix-granite. EPP uses approximate prefix-cache-scorer
(hash-based, no tokenizer — works for trust_remote_code models like sarvam-30b) +
...
INCLUDE_STAGES = [1, 2, 3, 4, 5, 6, 7, 8]  # skip warmup
...
plt.tight_layout()
out = BASE / "comparison_rates_3_to_50.png"
