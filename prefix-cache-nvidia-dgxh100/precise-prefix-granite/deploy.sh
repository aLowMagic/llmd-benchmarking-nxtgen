...
#
# Env vars:
#   NAMESPACE                (default: llm-d-granite-kv)
...
#                            HF_TOKEN env is unset (default: llm-d-precise-prefix-granite)

set -euo pipefail

NAMESPACE="${NAMESPACE:-llm-d-granite-kv}"
SOURCE_NAMESPACE="${SOURCE_NAMESPACE:-llm-d-precise-prefix-granite}"
